...
class RandomDataLoader(AdaptiveDSSDataLoader):
    ...
    """
    def __init__(self, train_loader, dss_args, logger, dataset_name=None, model_name=None, ratio=None, *args, **kwargs):
        """
    ...
    def _resample_subset_indices(self):
        ...
        if self.dataset_name == 'ars':
            try:
                ...
                # Save to CSV
                os.makedirs("../data/" +str(self.dataset_name)+"/"+str(self.dataset_name)+"_"+str(self.ratio)+"/selected_data_random/"+ str(self.model_name)+"/", exist_ok=True)
                csv_filename = f"../data/" +str(self.dataset_name)+"/"+str(self.dataset_name)+"_"+str(self.ratio)+"/selected_data_random/"+ str(self.model_name)+"/selected_data_"+ str(self.model_name)+"_epoch_"+str(self.cur_epoch)+".csv"
        ...
        if self.dataset_name == 'census':
            try:
                ...
                # Save to CSV
                os.makedirs("../data/adult/"+str(self.dataset_name)+"_"+str(self.ratio)+"/selected_data_random/"+ str(self.model_name)+"/", exist_ok=True)
                csv_filename = f"../data/adult/"+str(self.dataset_name)+"_"+str(self.ratio)+"/selected_data_random/"+ str(self.model_name)+"/selected_data_"+ str(self.model_name)+"_epoch_"+str(self.cur_epoch)+".csv"
                df.to_csv(csv_filename, index=False)
            except Exception as e:
                self.logger.error(f"Error during data processing: {e}")
        ...
        if self.dataset_name == 'mobiact':
            try:
                ...
                # Save to CSV
                os.makedirs("../data/" +str(self.dataset_name)+"/"+str(self.dataset_name)+"_"+str(self.ratio)+"/selected_data_radom/"+ str(self.model_name)+"/", exist_ok=True)
                csv_filename = f"../data/" +str(self.dataset_name)+"/"+str(self.dataset_name)+"_"+str(self.ratio)+"/selected_data_random/"+ str(self.model_name)+"/selected_data_"+ str(self.model_name)+"_epoch_"+str(self.cur_epoch)+".csv"
                df.to_csv(csv_filename, index=False)
            except Exception as e:
                self.logger.error(f"Error during data processing: {e}")
